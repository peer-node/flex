...
class ATeleportMiner : public Test
{
public:
    TeleportMiner miner;
};

TEST_F(ATeleportMiner, IsNotInitiallyMining)
{
    ASSERT_FALSE(miner.IsMining());
}

TEST_F(ATeleportMiner, InitiallyHasNoMiningInfo)
{
    ASSERT_THAT(miner.network_id_to_mining_info.size(), Eq(0));
}


class ATeleportMinerWithMiningInfo : public ATeleportMiner
{
public:
...
TEST_F(ATeleportMinerWithMiningInfo, HasMiningInfo)
{
    ASSERT_THAT(miner.network_id_to_mining_info.size(), Eq(1));
}

TEST_F(ATeleportMinerWithMiningInfo, ReturnsAValidBranchForTheMiningInfo)
{
...
class ATeleportMinerWithAProofListener : public ATeleportMinerWithMiningInfo
{
public:
    ...
    virtual void SetUp()
    {
        ATeleportMinerWithMiningInfo::SetUp();
...
TEST_F(ATeleportMinerWithAProofListener, MakesAnRPCCallAfterEachProofIfPortIsNonZero)
{
...
TEST_F(ATeleportMinerWithAProofListener, SendsAValidNetworkSpecificProofOfWorkWithTheRPCCall)
{
    miner.StartMining();
