...
public:
    ...
    JSON(public_key, number, mined_credit_message_hash, join_message_hash, key_distribution_message_hash,
         ...
         second_set_of_key_sixteenth_holders, secret_recovery_message_hashes, obituary_hash, pending_complaints,
         pending_complaints_sent, upheld_complaints, refutations_of_complaints_sent, tasks);
