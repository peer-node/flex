...
static void
curve25519_sqrt(bignum25519 r, const bignum25519 a)
{
    bignum25519 v, i, x, y;
    curve25519_mul(x, a, two);
    curve25519_pow_two252m3(v, x);
    curve25519_mul(y, v, v);
    curve25519_mul(i, x, y);
    curve25519_sub(i, i, one);
    curve25519_mul(x, v, a);
    curve25519_mul(r, x, i);
}
