...
#if defined(SCRYPT__SALSA64_AVX2)
...
#if defined(SCRYPT__SALSA64_XOP)
...
#if defined(SCRYPT__SALSA64_AVX)
...
#if defined(SCRYPT__SALSA64_SSSE3)
...
#if defined(SCRYPT__SALSA64_SSE2)
...
//#define TWIST_PREPARE_FN twist_ROMix_prepare_basic
#define TWIST_WORK_FN twist_ROMix_work_basic
#define TWIST_VERIFY_FN twist_ROMix_verify_basic
#define TWIST_CHECKRECORDEDSTEPS_FN twist_ROMix_checkrecordedsteps_basic
#define TWIST_QUICKCHECK_FN twist_ROMix_quickcheck_basic
...
static twist_ROMixfn_prepare
twist_getROMix_prepare(void) {
    return twist_ROMix_prepare_basic;
}

static twist_ROMixfn_work
twist_getROMix_work(void) {
    return twist_ROMix_work_basic;
}

static twist_ROMixfn_verify
twist_getROMix_verify(void) {
    return twist_ROMix_verify_basic;
}

static twist_ROMixfn_checkrecordedsteps
twist_getROMix_checkrecordedsteps(void) {
    return twist_ROMix_checkrecordedsteps_basic;
}

static twist_ROMixfn_quickcheck
twist_getROMix_quickcheck(void) {
    return twist_ROMix_quickcheck_basic;
}
#endif
