...
/* determine compiler */
	...
	#define ALIGN22(n) __declspec(align(n))
#endif
#if defined(__ICC)
...
#if defined(__GNUC__)
	#if (__GNUC__ >= 3)
		#define COMPILER__GCC_PATCHLEVEL __GNUC_PATCHLEVEL__
	#else
		#define COMPILER__GCC_PATCHLEVEL 0
	#endif
	#define COMPILER__GCC (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + COMPILER__GCC_PATCHLEVEL)
	#define ROTL32(a,b) (((a) << (b)) | ((a) >> (32 - b)))
	#define ROTR32(a,b) (((a) >> (b)) | ((a) << (32 - b)))
	#define ROTL64(a,b) (((a) << (b)) | ((a) >> (64 - b)))
	#define ROTR64(a,b) (((a) >> (b)) | ((a) << (64 - b)))
	#undef NOINLINE
	#if (COMPILER__GCC >= 30000)
	...
	#define ALIGN22(n) __attribute__((aligned(n)))
	#include <stdint.h>
#endif
...
#elif (defined(CPU_X86) && defined(COMPILER__GCC))
...
#elif (defined(CPU_X86_64) && defined(COMPILER__GCC))
	__asm__ __volatile__(
		"pushq %%rdi;\n"
		"pushq %%rcx;\n"
		"rep stosb;\n"
